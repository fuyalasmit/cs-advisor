            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">
                        Browse the CS curriculum by year and open each course for prerequisites, options, and details.
                    </p>
                </div>
                                                        ...
                                                        <span
                                                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                                                                slot.category === "major" || slot.slotType === "fixed"
                                                                    ...
                                                                    : slot.category === "concentration" ||
                                                                        slot.slotType === "concentration"
                                                    ...
                                                    <tr>
                                                        <td colSpan={4} className="px-4 py-4 bg-gray-50">
                                                            {slot.courseNo && courseDetails.has(slot.courseNo) ? (
                                                                <CourseDetailsView
                                                                    course={courseDetails.get(slot.courseNo)!}
                                                                />
                                                            ) : placeholderOptions.length > 0 ? (
                                                                <PlaceholderOptionsView
                                                                    slot={slot}
            ...
            <div className="space-y-2 max-h-96 overflow-y-auto">
                {options.map((course) => (
                    <div key={course.courseNo} className="border border-gray-200 rounded-lg">
                        <div
                            onClick={() =>
                                setExpandedCourse(expandedCourse === course.courseNo ? null : course.courseNo)
                            }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                        {course.requiredFor.map((req, idx) => (
                            <div key={idx} className="text-sm bg-white rounded p-2 border border-gray-200">
                                ...
                                {req.minGrade && (
                                    <div className="text-xs text-gray-500 mt-1">Min grade: {req.minGrade}</div>
                                )}
                            </div>
                        ))}
                    </div>
